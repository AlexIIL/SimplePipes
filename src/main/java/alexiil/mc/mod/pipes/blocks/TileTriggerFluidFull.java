...
import alexiil.mc.lib.attributes.fluid.IFluidInvStats.FluidInvStatistic;
...
public class TileTriggerFluidFull extends TileTrigger {
    ...
    protected EnumTriggerState getTriggerState(Direction dir) {
        ...
        if (stats.spaceTotal == -1) {
            // Not good!
            LibBlockAttributes.LOGGER.warn("Found an IFluidInvStats implementation that doesn't correctly "
