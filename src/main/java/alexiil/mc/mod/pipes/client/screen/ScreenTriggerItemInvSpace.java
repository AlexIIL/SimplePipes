...
public class ScreenTriggerItemInvSpace extends ContainerScreen<ContainerTriggerInvSpace> {
    ...
    public ScreenTriggerItemInvSpace(ContainerTriggerInvSpace container) {
        super(container, container.player.inventory, SimplePipeBlocks.TRIGGER_ITEM_INV_SPACE.getTextComponent());
        height = 153;
    }
